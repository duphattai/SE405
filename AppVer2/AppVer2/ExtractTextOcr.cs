...
namespace AppVer2
{
    class ExtractTextOcr
    {
        ...
        public async Task<string> ExtractText(WriteableBitmap bitmap, Image prevImage, double fontSize, OcrLanguage language)
        {
             OcrEngine ocrEngine = new OcrEngine(language);
